...
<div class="layui-layout layui-layout-admin">
    ...
    <!--侧边栏 -->
    <div class="layui-side layui-bg-black admin-panel">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree " lay-filter="left-nav" style="border-radius: 0;">
            </ul>
        </div>
    </div>
    <div class="panel-toggle"><i class="fa fa-chevron-right"></i></div>
    ...
    <div class="layui-footer" style="text-align: center; line-height: 44px;">
        Copyright © 2012-2016 All Rights Reserved.  大爱网(daaiweb.com).保留所有权利     豫ICP备15020515号
    </div>
</div>
